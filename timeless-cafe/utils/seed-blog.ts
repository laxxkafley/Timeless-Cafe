...
// }
import prisma from "@/utils/db"; // Ensure this points to your Prisma client instance
import hashPassword from "@/utils/hashPassword"; // Ensure hashPassword utility is correctly imported

export default async function seedPoems() {
  // Seed poems
  const poems = [
    { title: "Ode to Nature", content: "The leaves whisper secrets of the forest untamed...", author: "Emily Green" },
    { title: "Journey of the Stars", content: "Through the cosmos vast and wide...", author: "Alexander Moon" },
    { title: "Reflections of Time", content: "Mirror of life, reflecting moments gone by...", author: "Lara Stone" },
    { title: "Heart of the Forest", content: "In the green embrace of ancient trees...", author: "Sylvia Wood" },
    { title: "The River’s Song", content: "Flowing gently, steady and strong...", author: "Ryan Brook" },
    { title: "Whispers of the Sea", content: "The sea whispers secrets on the shore...", author: "Ocean Blue" },
    { title: "The Dance of Autumn", content: "The trees begin to shed their leaves...", author: "Autumn Ray" },
    { title: "The Song of the Mountains", content: "The mountains stand tall, reaching the skies...", author: "Oliver Stone" },
    { title: "The Light of the Moon", content: "Beneath the moon's soft, silver glow...", author: "Luna Night" },
    { title: "The Silent Garden", content: "In the silent garden, flowers bloom...", author: "Rose Williams" },
    { title: "The Dreamer’s Path", content: "A dreamer walks a winding road...", author: "Eliot Blue" },
    { title: "The Echo of the Forest", content: "The forest speaks in whispers deep...", author: "Isla Green" },
    { title: "The Flame of Hope", content: "A flame burns bright in the darkest night...", author: "Aidan Hope" },
    { title: "Echoes of Yesterday", content: "The echoes of yesterday call to me...", author: "Mia Sands" },
    { title: "The Wings of Freedom", content: "The wings of freedom stretch wide and strong...", author: "Sierra Sky" },
  ];

  // Seed poems to database
  for (const poem of poems) {
    await prisma.poem.create({
      data: poem,
    });
